...
<body onload="showmsg()">
    <div class="main">
        <h2 class="title"><span>教师管理</span></h2>
        <form action="<c:url value="/tea/deletes"/>" method="post">
        <table border="1" width="100%" class="tab">
            ...
            <c:forEach var="m" items="${tealist}" varStatus="status">
                <tr>
                    ...
                    <td>${m.ttype}</td>
                    <td>
                    <a href="<c:url value="/tea/"/>delete/${m.id}" class="abtn">删除</a>
                    <a href="${pageContext.request.contextPath }/tea/showedit/${m.id}" class="abtn">编辑</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
        ...
        <div id="pager"></div>
        <p>
            <a href="${pageContext.request.contextPath }/tea/showadd" class="abtn out">添加</a>
        ...
        <script type="text/javascript">
           ...
           function handlePaginationClick(new_page_index, pagination_container){
               location.href="<c:url value="/tea"/>?pageNO="+(new_page_index+1);
           }
