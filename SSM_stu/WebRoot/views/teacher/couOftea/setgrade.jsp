...
<body>
    <div class="main">
        ...
        <form:form action="${pageContext.request.contextPath}/tea/saveGrade" modelAttribute="grade">
        <fieldset>
            <legend>成绩</legend>
            ...
            <p>
                <label for="type">最终成绩</label>
                <form:input path="zgrade" size="50"/>
                <form:errors path="zgrade" cssClass="error"></form:errors>
            </p>
            <p>
